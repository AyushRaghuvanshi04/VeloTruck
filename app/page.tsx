...
export default function Home() {
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      {/* Floating orbs */}
      <div className="absolute top-20 left-10 w-96 h-96 bg-primary/10 rounded-full blur-3xl animate-float" style={{ animationDelay: '0s' }} />
      ...
      <div className="container mx-auto px-4 py-8 sm:py-12 lg:py-16 relative z-10">
        ...
        <div className="text-center mb-20 lg:mb-24">
          ...
          <ScrollReveal delay={200}>
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-extrabold mb-6 leading-tight max-w-5xl mx-auto">
              <span className="block bg-gradient-to-r from-primary via-primary to-secondary bg-clip-text text-transparent mb-4">
                Reduce Empty Return Miles by 30%
              </span>
              <span className="block text-2xl sm:text-3xl lg:text-4xl font-normal text-gray-700">
          ...
          <ScrollReveal delay={600}>
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
              <Link href="/dashboard/shipper/post-load" className="group">
                <Button size="lg" className="h-32 w-48 flex flex-col items-center justify-center gap-3 bg-gradient-to-r from-primary via-primary to-primary/90 hover:from-primary/90 hover:via-primary hover:to-primary shadow-2xl hover:shadow-primary/50 transition-all hover:scale-110 active:scale-95 border-2 border-primary/20 rounded-2xl">
                  <Package className="h-8 w-8 text-white group-hover:rotate-12 transition-transform" />
                  <span className="text-lg font-bold text-white">Book a Load</span>
                  <ArrowRight className="h-5 w-5 text-white group-hover:translate-x-1 transition-transform" />
                </Button>
              </Link>
              <Link href="/dashboard/carrier" className="group">
                <Button size="lg" variant="secondary" className="h-32 w-48 flex flex-col items-center justify-center gap-3 bg-gradient-to-r from-secondary via-secondary to-secondary/90 hover:from-secondary/90 hover:via-secondary hover:to-secondary shadow-2xl hover:shadow-secondary/50 transition-all hover:scale-110 active:scale-95 border-2 border-secondary/20 rounded-2xl">
                  <Truck className="h-8 w-8 text-white group-hover:rotate-12 transition-transform" />
                  <span className="text-lg font-bold text-white">Join as Carrier</span>
                  <ArrowRight className="h-5 w-5 text-white group-hover:translate-x-1 transition-transform" />
                </Button>
              </Link>
              <Link href="/dashboard/admin" className="group">
                <Button size="lg" variant="outline" className="h-32 w-48 flex flex-col items-center justify-center gap-3 border-2 bg-white/90 backdrop-blur-sm hover:bg-gradient-to-r hover:from-gray-50 hover:to-gray-100 shadow-xl hover:shadow-2xl transition-all hover:scale-110 active:scale-95 border-gray-300 hover:border-primary/50 rounded-2xl">
                  <Shield className="h-8 w-8 text-gray-700 group-hover:rotate-12 transition-transform" />
                  <span className="text-lg font-bold text-gray-700">Admin Portal</span>
          ...
          <ScrollReveal delay={800}>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-16">
              <div className="glass rounded-2xl p-6 shadow-xl border border-white/50 hover:shadow-2xl transition-all hover:scale-105">
                <div className="flex items-center justify-center mb-3">
                  <div className="h-12 w-12 rounded-xl bg-gradient-to-br from-primary to-primary/80 flex items-center justify-center shadow-lg">
                    <Truck className="h-6 w-6 text-white" />
                  </div>
                </div>
                <div className="text-3xl font-bold bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">10K+</div>
                <div className="text-sm text-gray-600 font-medium">Active Trucks</div>
              </div>
              <div className="glass rounded-2xl p-6 shadow-xl border border-white/50 hover:shadow-2xl transition-all hover:scale-105">
                <div className="flex items-center justify-center mb-3">
                  <div className="h-12 w-12 rounded-xl bg-gradient-to-br from-secondary to-secondary/80 flex items-center justify-center shadow-lg">
                    <Package className="h-6 w-6 text-white" />
                  </div>
                </div>
                <div className="text-3xl font-bold bg-gradient-to-r from-secondary to-secondary/70 bg-clip-text text-transparent">50K+</div>
                <div className="text-sm text-gray-600 font-medium">Loads Delivered</div>
              </div>
              <div className="glass rounded-2xl p-6 shadow-xl border border-white/50 hover:shadow-2xl transition-all hover:scale-105">
                <div className="flex items-center justify-center mb-3">
                ...
                <div className="text-3xl font-bold bg-gradient-to-r from-green-600 to-green-500 bg-clip-text text-transparent">5K+</div>
                <div className="text-sm text-gray-600 font-medium">Verified Users</div>
              </div>
              <div className="glass rounded-2xl p-6 shadow-xl border border-white/50 hover:shadow-2xl transition-all hover:scale-105">
                <div className="flex items-center justify-center mb-3">
                ...
                <div className="text-3xl font-bold bg-gradient-to-r from-yellow-600 to-yellow-500 bg-clip-text text-transparent">99%</div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Card className="glass border-0 shadow-xl hover:shadow-2xl transition-all hover:scale-105">
                <CardContent className="p-8 text-center">
                  <div className="h-16 w-16 rounded-xl bg-gradient-to-br from-green-500 to-green-600 flex items-center justify-center mx-auto mb-4 shadow-lg">
                    <FileCheck className="h-8 w-8 text-white" />
                  </div>
                  <h3 className="text-xl font-bold mb-2">GST Verified</h3>
                  <p className="text-sm text-gray-600">Fully compliant with Indian tax regulations</p>
                </CardContent>
              </Card>
              <Card className="glass border-0 shadow-xl hover:shadow-2xl transition-all hover:scale-105">
                <CardContent className="p-8 text-center">
                  <div className="h-16 w-16 rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center mx-auto mb-4 shadow-lg">
              ...
              <Card className="glass border-0 shadow-xl hover:shadow-2xl transition-all hover:scale-105">
                <CardContent className="p-8 text-center">
                  <div className="h-16 w-16 rounded-xl bg-gradient-to-br from-purple-500 to-purple-600 flex items-center justify-center mx-auto mb-4 shadow-lg">
          ...
          <div className="max-w-6xl mx-auto mb-20">
            ...
            <Card className="glass border-0 shadow-2xl overflow-hidden">
              <CardContent className="p-0">
                <div className="bg-gradient-to-br from-gray-50 to-gray-100 h-96 flex items-center justify-center relative">
                  <div className="text-center">
                    <div className="h-24 w-24 rounded-2xl bg-gradient-to-br from-primary to-secondary flex items-center justify-center mx-auto mb-4 shadow-xl">
